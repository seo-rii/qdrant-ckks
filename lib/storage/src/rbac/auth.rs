...
mod tests {
    ...
    fn audit_error_redaction_hides_private_oram_access_pattern_fields() {
        for error in [
            ...
            "private HNSW read failed query.embedding=private-query-embedding-dot-sentinel",
            "private HNSW read failed query.embeddings=private-query-embeddings-dot-sentinel",
            "private HNSW read failed query_plaintext=private-query-plaintext-sentinel",
            "private HNSW read failed query.plaintext=private-query-plaintext-dot-sentinel",
            "private HNSW read failed query.plaintexts=private-query-plaintexts-dot-sentinel",
            ...
            "private HNSW read failed node.score=private-node-score-dot-sentinel",
            "private HNSW read failed node.scores=private-node-scores-dot-sentinel",
            "private HNSW read failed node_distance=private-node-distance-sentinel",
            "private HNSW read failed node.distance=private-node-distance-dot-sentinel",
            "private HNSW read failed node.distances=private-node-distances-dot-sentinel",
            ...
            "private HNSW read failed access_volume=private-access-volume-sentinel",
            "private HNSW read failed access.volume=private-access-volume-dot-sentinel",
            "private HNSW read failed accessVolume=private-access-volume-camel-sentinel",
            "private HNSW read failed access_volume_count=private-access-volume-count-sentinel",
            "private HNSW read failed access.volume.count=private-access-volume-count-dot-sentinel",
            "private HNSW read failed accessVolumeCounts=private-access-volume-counts-sentinel",
            "private HNSW read failed access_volume_len=private-access-volume-len-sentinel",
            ...
            "private result ORAM read failed payload.fetch.tokens=private-fetch-tokens-dot-sentinel",
            ...
            "private result ORAM read failed point.token=private-point-token-dot-sentinel",
            "private result ORAM read failed point_tokens=private-point-tokens-sentinel",
            "private result ORAM read failed point.tokens=private-point-tokens-dot-sentinel",
            "private result ORAM read failed payload_plaintext=private-payload-sentinel",
            "private result ORAM read failed payload.plaintext=private-payload-dot-sentinel",
            "private result ORAM read failed tokenMap=private-token-map-sentinel",
            "private result ORAM read failed tokenMapBackup=private-token-map-backup-singular-sentinel",
            "private result ORAM read failed tokenMapBackups=private-token-map-backup-sentinel",
            "private result ORAM read failed token_maps=private-token-maps-sentinel",
            "private result ORAM read failed token.maps=private-token-maps-dot-sentinel",
            "private result ORAM read failed token_map_snapshots=private-token-map-snapshots-sentinel",
            "private result ORAM read failed token.map.snapshots=private-token-map-snapshots-dot-sentinel",
            ...
            "private result ORAM read failed token.position.maps=private-token-position-maps-dot-sentinel",
            "private result ORAM read failed token_position_map_snapshots=private-token-position-map-snapshots-sentinel",
            "private result ORAM read failed token.position.map.snapshots=private-token-position-map-snapshots-dot-sentinel",
            ...
            "private result ORAM read failed read.bucket.id.sequence=private-read-bucket-sequence-dot-sentinel",
            ...
            "private ORAM proof failed proof_value=private-proof-value-sentinel",
            "private ORAM proof failed proof.value=private-proof-value-dot-sentinel",
            "private ORAM proof failed proofValue=private-proof-value-camel-sentinel",
            "private ORAM proof failed proof.values=private-proof-values-dot-sentinel",
            "private ORAM signature failed client_signature=private-client-signature-sentinel",
            "private ORAM signature failed client.signature=private-client-signature-dot-sentinel",
            "private ORAM signature failed commit.signature=private-commit-signature-dot-sentinel",
            "private ORAM signature failed manifest.signature=private-manifest-signature-dot-sentinel",
            "private ORAM signature failed read.signature=private-read-signature-dot-sentinel",
            "private ORAM bucket failed ciphertext_sha256=private-ciphertext-sha256-sentinel",
            "private ORAM bucket failed ciphertextSha256=private-ciphertext-sha256-camel-sentinel",
            "private ORAM bucket failed ciphertexts_sha256=private-ciphertexts-sha256-sentinel",
            "private ORAM bucket failed ciphertextsSha256=private-ciphertexts-sha256-camel-sentinel",
            "private ORAM bucket failed ciphertext_sha256_b64=private-ciphertext-sha256-b64-sentinel",
            "private ORAM bucket failed ciphertextSha256B64=private-ciphertext-sha256-b64-camel-sentinel",
            "private ORAM bucket failed bucket_commitment=private-bucket-commitment-sentinel",
            "private ORAM bucket failed bucket.commitment=private-bucket-commitment-dot-sentinel",
            "private ORAM bucket failed bucketCommitment=private-bucket-commitment-camel-sentinel",
            "private ORAM bucket failed bucket_commitments=private-bucket-commitments-sentinel",
            "private ORAM bucket failed bucket.commitments=private-bucket-commitments-dot-sentinel",
            "private ORAM bucket failed bucketCommitments=private-bucket-commitments-camel-sentinel",
            ...
            "private ORAM commit failed updated_bucket_commitment=private-updated-bucket-commitment-sentinel",
            "private ORAM commit failed updatedBucketCommitment=private-updated-bucket-commitment-camel-sentinel",
            "private ORAM commit failed updated_bucket_commitments=private-updated-bucket-commitments-sentinel",
            "private ORAM commit failed updatedBucketCommitments=private-updated-bucket-commitments-camel-sentinel",
            ...
            "private ORAM client backup failed client_states=private-client-states-snake-sentinel",
            "private ORAM client backup failed clientStates=private-client-states-camel-sentinel",
            ...
            "private ORAM client backup failed client.state.snapshot=private-client-state-snapshot-dot-sentinel",
            ...
            "private ORAM client backup failed client.state.snapshots=private-client-state-snapshots-snake-sentinel",
            ...
            "private ORAM client backup failed encrypted.client.state=private-encrypted-client-state-dot-sentinel",
            "private ORAM client backup failed encrypted.client.state.snapshot=private-encrypted-client-state-snapshot-dot-sentinel",
            ...
            "private ORAM client backup failed encrypted.client.state.snapshots=private-encrypted-client-state-snapshots-snake-sentinel",
            ...
            "private ORAM client backup failed client_state_ciphertext_sha256.bin=private-client-state-ciphertext-sha256-bin-sentinel",
            "private ORAM client backup failed client_state_ciphertext_sha256.json=private-client-state-ciphertext-sha256-json-sentinel",
            "private ORAM client backup failed client_state_ciphertexts_sha256=private-client-state-ciphertexts-sha256-sentinel",
            "private ORAM client backup failed client_state_ciphertexts_sha256.bin=private-client-state-ciphertexts-sha256-bin-sentinel",
            "private ORAM client backup failed client_state_ciphertexts_sha256.json=private-client-state-ciphertexts-sha256-json-sentinel",
            ...
            "private ORAM client backup failed client_state_ciphertext_hash=private-client-state-ciphertext-hash-snake-sentinel",
            "private ORAM client backup failed client_state_ciphertext_hash.bin=private-client-state-ciphertext-hash-bin-sentinel",
            "private ORAM client backup failed client_state_ciphertext_hash.json=private-client-state-ciphertext-hash-json-sentinel",
            "private ORAM client backup failed client_state_ciphertext_hashes=private-client-state-ciphertext-hashes-snake-sentinel",
            "private ORAM client backup failed client_state_ciphertext_hashes.bin=private-client-state-ciphertext-hashes-bin-sentinel",
            "private ORAM client backup failed client_state_ciphertext_hashes.json=private-client-state-ciphertext-hashes-json-sentinel",
            ...
            "private ORAM client backup failed encrypted_client_state_ciphertext_sha256.bin=private-encrypted-client-state-ciphertext-sha256-bin-sentinel",
            "private ORAM client backup failed encrypted_client_state_ciphertext_sha256.json=private-encrypted-client-state-ciphertext-sha256-json-sentinel",
            ...
            "private ORAM client backup failed encrypted_client_state_ciphertexts_sha256.bin=private-encrypted-client-state-ciphertexts-sha256-bin-sentinel",
            "private ORAM client backup failed encrypted_client_state_ciphertexts_sha256.json=private-encrypted-client-state-ciphertexts-sha256-json-sentinel",
            ...
            "private ORAM client backup failed encrypted_client_state_ciphertext_hash.bin=private-encrypted-client-state-ciphertext-hash-bin-sentinel",
            "private ORAM client backup failed encrypted_client_state_ciphertext_hash.json=private-encrypted-client-state-ciphertext-hash-json-sentinel",
            ...
            "private ORAM client backup failed encrypted_client_state_ciphertext_hashes.bin=private-encrypted-client-state-ciphertext-hashes-bin-sentinel",
            "private ORAM client backup failed encrypted_client_state_ciphertext_hashes.json=private-encrypted-client-state-ciphertext-hashes-json-sentinel",
            ...
            "private ORAM client backup failed state_ciphertext_sha256.bin=private-state-ciphertext-sha256-bin-sentinel",
            "private ORAM client backup failed state_ciphertext_sha256.json=private-state-ciphertext-sha256-json-sentinel",
            "private ORAM client backup failed state_ciphertexts_sha256=private-state-ciphertexts-sha256-sentinel",
            "private ORAM client backup failed state_ciphertexts_sha256.bin=private-state-ciphertexts-sha256-bin-sentinel",
            "private ORAM client backup failed state_ciphertexts_sha256.json=private-state-ciphertexts-sha256-json-sentinel",
            ...
            "private ORAM client backup failed state_ciphertext_hash.bin=private-state-ciphertext-hash-bin-sentinel",
            "private ORAM client backup failed state_ciphertext_hash.json=private-state-ciphertext-hash-json-sentinel",
            "private ORAM client backup failed state_ciphertext_hashes=private-state-ciphertext-hashes-snake-sentinel",
            "private ORAM client backup failed state_ciphertext_hashes.bin=private-state-ciphertext-hashes-bin-sentinel",
            "private ORAM client backup failed state_ciphertext_hashes.json=private-state-ciphertext-hashes-json-sentinel",
