...
mod tests {
    ...
    fn audit_error_redaction_hides_private_oram_access_pattern_fields() {
        for error in [
            ...
            "private HNSW read failed candidate.score=private-candidate-score-dot-sentinel",
            "private HNSW read failed candidate.scores=private-candidate-scores-dot-sentinel",
            "private HNSW read failed candidate_distance=private-candidate-distance-sentinel",
            "private HNSW read failed candidate.distance=private-candidate-distance-dot-sentinel",
            "private HNSW read failed candidate.distances=private-candidate-distances-dot-sentinel",
            "private HNSW read failed distance.score=private-distance-score-dot-sentinel",
            "private HNSW read failed distance.scores=private-distance-scores-dot-sentinel",
