...
pub use private_hnsw_client::{
    ...
    PrivateHnswBucketAeadBaseContext, PrivateHnswBucketAeadContext,
    ...
    PrivateHnswOramClientConfig, PrivateHnswOramClientState, PrivateHnswOramMerkleProof,
    PrivateHnswOramMerkleProofLeaf, PrivateHnswOramMerkleSibling, PrivateHnswOramPlaintextBucket,
    PrivateHnswPlaintextIndexBuild, PrivateHnswSearchHit, PrivateHnswSearchParams,
    PrivateHnswSearchResult, PrivateHnswVectorEncoding, access_private_hnsw_oram_path,
    build_private_hnsw_oram_plaintext_index_from_blocks, decode_private_hnsw_node_block,
