...
pub use private_hnsw_client::{
    ...
    PrivateHnswSearchHit, PrivateHnswSearchParams, PrivateHnswSearchResult,
    PrivateHnswVectorEncoding, access_private_hnsw_oram_path, decode_private_hnsw_node_block,
