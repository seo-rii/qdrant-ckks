...
pub use private_result_oram::{
    ...
    PrivateResultOramBucket, PrivateResultOramBucketValidationContext,
    PrivateResultOramClientCommitBucketRef, PrivateResultOramCommitBucketRef,
    PrivateResultOramCommitPlan, PrivateResultOramCommitSignatureInput, PrivateResultOramEpoch,
    ...
    private_result_oram_merkle_root_for_commitments, validate_private_result_oram_bucket_shape,
