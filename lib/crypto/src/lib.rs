...
pub use private_result_oram::{
    ...
    fetch_private_result_oram_tokens_encrypted_verified, open_private_result_oram_bucket,
    open_private_result_oram_client_state_snapshot, open_private_result_oram_plaintext_bucket,
    open_private_result_oram_verified_bucket_batch, package_private_result_oram_upload_bundle,
    plan_private_result_oram_commit, plan_private_result_oram_commit_for_manifest,
