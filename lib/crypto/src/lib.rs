...
pub use private_hnsw_client::{
    ...
    PrivateHnswPositionMapSnapshotEntry, PrivateHnswSearchAccessMetrics, PrivateHnswSearchHit,
    PrivateHnswSearchParams, PrivateHnswSearchResult, PrivateHnswSpeculativePrefetchPlan,
    PrivateHnswVectorEncoding, access_private_hnsw_oram_path,
...
pub use private_result_oram::{
    ...
    PrivateResultOramEpoch, PrivateResultOramError, PrivateResultOramManifest,
    ...
    plan_private_result_oram_commit_for_manifest, private_result_oram_bucket_commitment,
