...
pub use private_hnsw_client::{
    ...
    PrivateHnswClientKeys, PrivateHnswCommitSignatureContext, PrivateHnswEncryptedIndexBuild,
    ...
    search_private_hnsw_oram_encrypted_verified, search_private_hnsw_oram_plaintext,
