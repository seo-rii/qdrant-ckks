...
pub use private_result_oram::{
    ...
    PRIVATE_RESULT_ORAM_MERKLE_PROOF_KIND, PrivateResultOramAccessResult, PrivateResultOramBucket,
    PrivateResultOramBucketAeadBaseContext, PrivateResultOramBucketAeadContext,
    PrivateResultOramBucketCommitmentContext, PrivateResultOramBucketValidationContext,
    PrivateResultOramClientCommitBucketRef, PrivateResultOramClientConfig,
    PrivateResultOramClientKeys, PrivateResultOramClientState, PrivateResultOramCommitBucketRef,
    ...
    open_private_result_oram_bucket, open_private_result_oram_plaintext_bucket,
