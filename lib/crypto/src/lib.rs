...
pub use private_hnsw_client::{
    ...
    PrivateHnswOramPlaintextBucket, PrivateHnswPlaintextIndexBuild, PrivateHnswSearchHit,
    PrivateHnswSearchParams, PrivateHnswSearchResult, PrivateHnswVectorEncoding,
    access_private_hnsw_oram_path, build_private_hnsw_oram_plaintext_index_from_blocks,
