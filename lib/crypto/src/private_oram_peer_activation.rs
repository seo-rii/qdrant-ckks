...
pub const PRIVATE_ORAM_PEER_ACTIVATION_PROTOCOL_VERSION: u16 = 1;
...
pub fn try_private_oram_consensus_configuration_digest_v1(
    ...
    push_u16(&mut message, PRIVATE_ORAM_PEER_ACTIVATION_PROTOCOL_VERSION);
...
pub fn validate_private_oram_peer_activation_challenge_v1_shape(
    ...
    if challenge.protocol_version != PRIVATE_ORAM_PEER_ACTIVATION_PROTOCOL_VERSION {
...
fn validate_ack_context(
    ...
    if ack.protocol_version != PRIVATE_ORAM_PEER_ACTIVATION_PROTOCOL_VERSION {
        return Err(PrivateOramPeerActivationError::UnsupportedProtocolVersion);
    }
