    ...
    fn health_checker_panic_message_redacts_crypto_material() {
        let message = redact_health_checker_panic_message(
            "health panic with session_token=session-token-sentinel, signatureB64=sig-sentinel, \
             ...
             access.volume=access-volume-dot-sentinel, \
             access_volumes=access-volumes-snake-sentinel, \
             access.volumes=access-volumes-dot-sentinel, \
             access_volume_len=access-volume-len-snake-sentinel, \
             access.volume.len=access-volume-len-dot-sentinel, \
             access_volume_count=access-volume-count-snake-sentinel, \
             access.volume.count=access-volume-count-dot-sentinel, \
             access_volume_counts=access-volume-counts-snake-sentinel, \
             access.volume.counts=access-volume-counts-dot-sentinel, \
             access_volume_length=access-volume-length-snake-sentinel, \
             access.volume.length=access-volume-length-dot-sentinel, \
             ...
             bucket.commitment=bucket-commitment-dot-sentinel, \
             bucket_commitments=bucket-commitments-snake-sentinel, \
             bucket.commitments=bucket-commitments-dot-sentinel, \
        ...
        assert!(!message.contains("access-count-camel-sentinel"));
        assert!(!message.contains("access-counts-camel-sentinel"));
        assert!(!message.contains("access-count-snake-sentinel"));
        ...
        assert!(!message.contains("access-volume-lengths-camel-sentinel"));
        assert!(!message.contains("access-volume-snake-sentinel"));
        assert!(!message.contains("access-volume-len-snake-sentinel"));
        ...
        assert!(!message.contains("encrypted-client-state-snapshot-bin-sentinel"));
        assert!(!message.contains("encrypted-client-state-snapshot-json-sentinel"));
        assert!(!message.contains("encrypted-client-state-snapshots-json-sentinel"));
        assert!(!message.contains("client-state-ciphertext-camel-sentinel"));
        assert!(!message.contains("client-state-ciphertexts-snake-sentinel"));
        assert!(!message.contains("client-state-ciphertext-sha256-snake-sentinel"));
        assert!(!message.contains("client-state-ciphertexts-sha256-snake-sentinel"));
        assert!(!message.contains("client-state-ciphertexts-sha256-bin-sentinel"));
        assert!(!message.contains("client-state-ciphertexts-sha256-json-sentinel"));
        assert!(!message.contains("client-state-ciphertext-sha256-camel-sentinel"));
        assert!(!message.contains("client-state-ciphertexts-sha256-camel-sentinel"));
        ...
        assert!(!message.contains("client-state-ciphertext-hash-bin-sentinel"));
        assert!(!message.contains("client-state-ciphertext-hash-json-sentinel"));
        assert!(!message.contains("client-state-ciphertext-hashes-bin-sentinel"));
        assert!(!message.contains("client-state-ciphertext-hashes-json-sentinel"));
        assert!(!message.contains("client-state-ciphertext-hashes-snake-sentinel"));
        assert!(!message.contains("client-state-ciphertext-sha256-bin-sentinel"));
        assert!(!message.contains("client-state-ciphertext-sha256-json-sentinel"));
        ...
        assert!(!message.contains("encrypted-client-state-ciphertexts-sha256-snake-sentinel"));
        assert!(!message.contains("encrypted-client-state-ciphertexts-sha256-bin-sentinel"));
        assert!(!message.contains("encrypted-client-state-ciphertexts-sha256-json-sentinel"));
        assert!(!message.contains("encrypted-client-state-ciphertext-sha256-camel-sentinel"));
        assert!(!message.contains("encrypted-client-state-ciphertexts-sha256-camel-sentinel"));
        ...
        assert!(!message.contains("encrypted-client-state-ciphertext-hash-bin-sentinel"));
        assert!(!message.contains("encrypted-client-state-ciphertext-hash-json-sentinel"));
        assert!(!message.contains("encrypted-client-state-ciphertext-hashes-bin-sentinel"));
        assert!(!message.contains("encrypted-client-state-ciphertext-hashes-json-sentinel"));
        assert!(!message.contains("encrypted-client-state-ciphertext-hashes-snake-sentinel"));
        assert!(!message.contains("encrypted-client-state-ciphertext-sha256-bin-sentinel"));
        assert!(!message.contains("encrypted-client-state-ciphertext-sha256-json-sentinel"));
        ...
        assert!(!message.contains("state-ciphertexts-snake-sentinel"));
        ...
        assert!(!message.contains("state-ciphertext-hash-bin-sentinel"));
        assert!(!message.contains("state-ciphertext-hash-json-sentinel"));
        assert!(!message.contains("state-ciphertext-hashes-bin-sentinel"));
        assert!(!message.contains("state-ciphertext-hashes-json-sentinel"));
        assert!(!message.contains("state-ciphertext-hashes-snake-sentinel"));
        assert!(!message.contains("state-ciphertext-sha256-bin-sentinel"));
        assert!(!message.contains("state-ciphertext-sha256-json-sentinel"));
