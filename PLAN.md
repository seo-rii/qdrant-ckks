...
- Common/internal/gRPC create-field-index fixtures도 `private-result-oram/v1` payload path의 payload index/schema creation이 같은 private result ORAM session API 안내로 fail closed 되는지 고정한다.
