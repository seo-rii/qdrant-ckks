...
- private result ORAM skeleton의 manifest-aware commit planning/signature helper도 empty commit과, updated bucket commitment가 ciphertext hash와 collection/key lineage/bucket epoch context에 묶여 있지 않은 commit을 future 서명/검증 전에 fail closed 한다.
