...
- REST private HNSW/result ORAM DTO `Debug` fixtures도 encrypted bucket ciphertext뿐 아니라 `ciphertext_sha256`와 bucket commitment까지 upload/read response wrapper에서 반사하지 않는지 직접 고정한다.
