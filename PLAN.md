...
- collection update/delete도 private ORAM lifecycle guard를 잡아 active session/upload window가 있는 collection 설정 변경이나 삭제를 fail closed 하고, update/delete 중 새 private ORAM session/upload가 열리지 않게 한다.
