...
and server scoring, including ordinary query/fusion and search matrix paths,
fail closed and direct clients to the private HNSW ORAM session APIs. Phase 11
