...
HNSW pruning, quantization, ACORN/indexed-only params, recommend/discover vector
arithmetic, search matrix, prefetch/fusion/MMR, or encrypted query ciphertexts.
Direct collection-internal calls without runtime settings still fail closed for
