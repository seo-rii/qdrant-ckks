...
the graph. Qdrant prunes old persisted graph cache files by count and total
size after writing a new graph. It is still not Qdrant segment-native index
state.
