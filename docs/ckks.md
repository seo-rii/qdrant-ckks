...
legacy search, batch search, universal query, and batch query over server-side
...
settings are unavailable or invalid. Decrypted payload responses for
recommend/discover, grouped reads, export, logs, and telemetry remain future
work.
